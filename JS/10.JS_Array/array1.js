/*
    배열 : 여러 데이터를 하나의 볍ㄴ수에 저장하고자 할 때 사용
*/

/*
    배열 리터럴 : 
    - 0개 이상의 값을 쉼표로 구분하여 []로 묶어 표현
    - 배열 [인덱스]로 요소에 접근 가능, 존재하지 않는 인덱스에 접근하면 undifined 반환
...
/*
    - for-in 방식은 index를 사용하여 한번 더 접근을 해야하기 때문에 단순히 읽어들이는 작업만 할 때는 적합하지 않을 수 있음
...
/*
    indexOf(element) : 
    - 베열에 매개변수로 전달된 요소가 존재하면 첫번째 인덱스를 반환
    - 존재하지 않으면 -1을 반환
*/
