...
/*
    속성 이름 (속성 키) : 
    - 일반적으로 문자열로 표기함
    - 자바스크립트에서 유효한 변수명일 경ㅇ우에는 따옴표 생략 가능
...
/*
    ...
    - 객체에 존재하지 않는 속성에 접근하려 하몀ㄴ undefined를 반환
*/
...
/*
    속성 값 변경 : 객체 속성에 접근하여 새로운 값을 할당하면 변경가능
...
/*
    속성 삭제 : delete 연산자를 사용하여 속성 제거 가능
    - 
*/
