...
/*
    - + 단항 연산자는 숫자 타입이 아닌 피연산자에 사용하여 숫자 타입으로 변환 시킬 수 있음 
*/
...
/*
    ...
    - !== 불일치 비교
*/
// 동등, 부등 비교는 자동형 변환을 수행 후 연산 진행 (데이터 타입 영향을 받지 않음)
// console.log(10 == '10');
...
/*
    대소 관계 비교 연산자 : 피연산자의 크기를 비교하여 논리값으로 반환
    - > : 좌항이 우항보다 크다
    - < : 좌항이 우항보다 작다
    - >= : 좌항이 우항보다 크거나 같다
    - <= : 좌항이 우항보다 작거나 같다
